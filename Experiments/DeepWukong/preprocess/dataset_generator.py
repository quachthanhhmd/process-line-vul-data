...
import os
import sys
module_path = os.path.abspath('/home/p9chakra/MY_DRIVES/ProgramFiles/evaluating-deep-learning-based-vulnerability-detection-models-on-realistic-datasets/models/DeepWukong/')
...
#               result_ids.append(process_parallel.remote(i,XFG_root_path=XFG_root_path,
